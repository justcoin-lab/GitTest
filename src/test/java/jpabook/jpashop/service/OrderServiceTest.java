...
class OrderServiceTest {
    ...
    public void 상품주문_재고수량초과() throws Exception{
        ...
        Member member = createMember();
        Item item_ = createBook("시골 jpa", 10000, 10);
        ...
        assertThrows(NotEnoughStockException.class, () ->
                orderService.order(member.getId(), item_.getId(), orderCount));
    ...
    public void 주문취소() {
        ...
        assertEquals(OrderStatus.CANCEL, getOrder.getStatus(),"주문취소 상태는 Cancel");
        assertEquals(10, item.getStockQuantity(),"취소된 상품 만큼 재고증가");
    }
